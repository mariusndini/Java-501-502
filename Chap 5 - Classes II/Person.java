...
public class Person
{
    //instance vars - these vars are unique to every instance of this variable.
    private String name;
    private Date born;
    ...
    //copy constructor - if we need a copy of an existing already person
    ...
    */
    ...
    {
        // we return a NEW date here so we do not return a reference to the original. 
        // so we do not have a privacy leak. 
    ...
    */
    ...
    // 1) A useful function to have in our class
